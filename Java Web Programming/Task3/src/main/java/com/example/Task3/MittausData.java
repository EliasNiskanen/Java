...
public class MittausData {
   ...
   @ManyToOne
   private MittausPaikka mittausPaikka;

   public MittausPaikka getMittausPaikka() {
       return mittausPaikka;
   }

   public void setMittausPaikka(MittausPaikka mittausPaikka) {
       this.mittausPaikka = mittausPaikka;
   }
